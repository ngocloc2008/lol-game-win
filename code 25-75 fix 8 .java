								...
								if (_gameResult == 'win') {
									...
									_prediction = _chance
										...
										if (_loseStreak == 15) {
											_prediction = 75;
											_chance = _prediction
												_betAmount = _previous_betAmount * 10;
										}
										if (_loseStreak == 16) {
												_prediction = 25;
											_chance = _prediction
